...
describe 'mistral::keystone::auth' do
  ...
  describe 'with default class parameters' do
    ...
    it { is_expected.to contain_keystone_service('mistral').with(
      :ensure      => 'present',
      :type        => 'workflow',
      :description => 'Openstack workflow Service'
    ) }

    it { is_expected.to contain_keystone_endpoint('RegionOne/mistral').with(
      :ensure       => 'present',
  ...
  describe 'when overriding auth name' do
    ...
    it { is_expected.to contain_keystone_service('mistraly') }
    it { is_expected.to contain_keystone_endpoint('RegionOne/mistraly') }
  end
  ...
  describe 'when overriding service name' do
    ...
    it { is_expected.to contain_keystone_service('mistral_service') }
    it { is_expected.to contain_keystone_endpoint('RegionOne/mistral_service') }
  end
